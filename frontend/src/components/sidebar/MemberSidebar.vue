...
import MemberRow from "../member/MemberRow.vue";
import MemberSection from "../member/MemberSection.vue";
...
<template>
  ...
  >
    <div
      class="px-3 pt-4 pb-2 text-[11px] font-medium tracking-widest uppercase"
        ...
        <div class="px-2 py-1 space-y-1">
          ...
          >
            ...
            <div class="flex-1 space-y-1.5">
              <div
                class="h-2.5 bg-muted animate-pulse rounded"
                :style="{ width: `${65 - i * 5}%` }"
              />
