...
<template>
  <div>
    <div
      class="rounded-xl border border-destructive/30 bg-destructive/5 p-4 flex flex-col gap-3"
    >
      <div class="flex items-start gap-3">
        <div
          class="p-2 rounded-lg bg-destructive/10 text-destructive shrink-0 mt-0.5"
        >
        ...
        <div>
          ...
          <p class="text-xs text-muted-foreground mt-1 leading-relaxed">
            ...
            >. Toàn bộ kênh, tin nhắn, file và dữ liệu trong phòng sẽ bị xóa
            vĩnh viễn.
          </p>
        </div>
      </div>
