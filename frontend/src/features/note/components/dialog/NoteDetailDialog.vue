          ...
          <div class="p-6">
            ...
            <div class="flex items-start justify-between mb-4 gap-3">
              <div class="flex items-center gap-2 flex-1 min-w-0">
                <div v-if="note?.color" class="w-2.5 h-2.5 rounded-full shrink-0"
            ...
            <div class="mt-5 pt-4 border-t border-border/50 space-y-3">
              ...
              <div class="flex items-center gap-2">
                <!-- Save to personal -->
                <button v-if="showSavePersonal" @click="handleSavePersonal" :disabled="savingPersonal"
                ...
                <button v-if="canManage" @click="$emit('delete', note!.id)"
