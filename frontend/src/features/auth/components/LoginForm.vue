...
<template>
  <div class="form-inner">
    ...
    <div class="social-row">
      <button class="sbtn" :class="{ 'sbtn--highlight': highlightGoogle }" title="Đăng nhập với Google"
    ...
    <div class="field">
      ...
      <div class="input-wrap">
        ...
        <Input id="l-username" v-model="form.username" class="fi" :class="{ 'fi--error': errors.username }"
    ...
    <div class="field">
      ...
      <div class="input-wrap">
        ...
        <Input id="l-password" :type="showPassword ? 'text' : 'password'" v-model="form.password" class="fi fi--padded"
